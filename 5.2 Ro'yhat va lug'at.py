...
phones={
        'iphone 14 pro':1400,
        'samsung s23 ultra':1300,
        'google m 6':700,
        'sony':1200,
        'redmi':500
        }
print("Ikkita telefon tanlang :")
orders=[]
for n in range(2):
    orders.append(input(f"{n+1} phone :").lower())

for order in orders:
    if order in phones:
        print(f"{order.title()} {phones[order]} so'm")
    else:
        print(f"Kechirasiz bizda {order} mavjud emas")
...
print("Ikkita brand nomini kiriting : ")
orders=[]
for n in range(2):
    orders.append(input(f"{n+1} brand :").lower())
    
for order in orders:
    if order in brands:
        print(f"{order.title()} {brands[order]} so'm ")
    else:
        print(f"Kechirasiz bizda {order} sotuvda yo'q")
...
#zakazlar=[]
#for n in range(3):
#    zakazlar.append(input(f"{n+1} car :").lower())
